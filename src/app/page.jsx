      ...
      <div className="container">
        ...
        <div className="intro-card">
          ...
          <div className="concept">
            <h3>📍 Mean (Average)</h3>
            <p>
              <strong>What it is:</strong> The &quot;center&quot; or
              &quot;balance point&quot; of your data. Imagine balancing all your
              data points on a seesaw - the mean is where the fulcrum needs to
              be!
            </p>
            <p>
              <strong>Real example:</strong> If 5 friends have heights of 160,
              165, 170, 175, 180 cm, the mean is (160+165+170+175+180)/5 = 170
              cm. This is the &quot;typical&quot; height.
            </p>
          </div>
          <div className="concept">
            <h3>📏 Standard Deviation (Spread)</h3>
            <p>
              <strong>What it is:</strong> How &quot;spread out&quot; your data
              is from the mean. Small = data clusters near the mean. Large =
              data spreads far from the mean.
            </p>
            <p>
              <strong>Real example:</strong> Test scores with mean 75 and std
              dev 5 means most students scored between 70-80. With std dev 15,
              scores vary widely from 60-90!
            </p>
            <p>
          ...
          <div className="concepts-grid">
              ...
              <div className="concept-content">
                ...
                <div className="visual-example">
                  ...
                  <div className="pdf-example">
                    <strong>PDF Example:</strong> P(2 ≤ X ≤ 3) = ∫[2,3] f(x)dx
                    for height
                  </div>
                </div>
              </div>
            ...
            <div className="concept-card">
              ...
              <div className="concept-content">
                ...
                <p>
                  <em>
                    Essential for understanding dependence and correlation
                  </em>
                </p>
              </div>
            </div>
            ...
            <div className="concept-card">
              ...
              <div className="concept-content">
                <p>
                  <strong>Key Idea:</strong> Future depends only on current
                  state, not history
                </p>
            ...
            <div className="concept-card">
              ...
              <div className="concept-content">
                <p>
                  <strong>Confidence Intervals:</strong> Range of plausible
                  values for unknown parameter
                </p>
                <p>
                  <strong>Hypothesis Testing:</strong> Is this effect real or
                  just random?
                </p>
        ...
        <div className="distribution-card" id="binomial">
          ...
          <div className="example-box">
            ...
            <p>
              A basketball player shoots 10 free throws. Each shot has 70%
              success rate. How many will they make? Could be 0, could be 10,
              but likely around 7!
            </p>
          </div>
          <div className="controls">
        ...
        <div className="distribution-card" id="poisson">
          ...
          <div className="example-box">
            ...
            <p>
              A coffee shop gets 3 customers per minute on average. In any
              minute, they might get 0, 1, 2, 3, 4, 5, or more! Poisson tells
              the likelihood.
            </p>
          </div>
          <div className="controls">
        ...
        <div className="distribution-card" id="normal">
          ...
          <div className="example-box">
            ...
            <p>
              Adult heights cluster around average; very short/tall are rare.
              IQ, test grades, errors often follow this pattern.
            </p>
          </div>
          <div className="controls">
            <div className="control-group">
        ...
        <div className="distribution-card" id="beta">
          ...
          <div className="example-box">
            ...
            <p>
              After 7 clicks in 10 visits, what&apos;s the underlying click
              rate? Beta models uncertainty.
            </p>
          </div>
          <div className="controls">
            <div className="control-group">
        ...
        <div className="distribution-card" id="multinomial">
          ...
          <div className="example-box">
            ...
            <p>
              Roll 10 dice: how many of each face? Or 100 shoppers choosing
              among 3 products.
            </p>
          </div>
          <div className="controls">
